...
class ToDoListApp:
    def __init__(self, root):
        ...
        self.tasks = []  # Menggunakan stack untuk menyimpan tugas

        # Tampilan awal
        self.create_start_screen()

    def create_start_screen(self):
        # Membuat tampilan awal dengan tombol Mulai.
    ...
    def start_app(self):
        # Memulai aplikasi dan menghapus tampilan awal.
    ...
    def create_main_screen(self):
        ...
        # List tugas
        self.task_listbox = tk.Listbox(self.root, width=50, height=10, font=("Arial", 12), bg="#e8e8e8", selectbackground="#4CAF50")
    ...
    def add_task(self):
        ...
        if task_name:
            ...
            self.tasks.append(new_task)  # Tambahkan ke stack
            self.tasks.sort(key=lambda t: t.time)  # Urutkan berdasarkan waktu
    ...
    def mark_done(self):
        ...
        while True:
            # Cek apakah ada tugas yang dipilih
            ...
            if selected_items:
                ...
                self.archive.append(selected_task)  # Pindahkan ke arsip
                del self.tasks[selected_index]  # Hapus dari daftar utama
                self.update_task_list()
                break 
            else:
                # Menampilkan pesan peringatan dan menunggu pengguna memilih tugas
                messagebox.showwarning("Peringatan", "Pilih tugas terlebih dahulu!")
                break  

    def delete_task(self):
        """Menghapus tugas dari stack dengan pengecekan."""
        while True:
            # Cek apakah ada tugas yang dipilih
            selected_items = self.task_listbox.curselection()
            if selected_items:
                ...
                self.update_task_list()
                break  # Keluar dari loop setelah tugas dihapus
            else:
                # Menampilkan pesan peringatan dan menunggu pengguna memilih tugas
                messagebox.showwarning("Peringatan", "Pilih tugas terlebih dahulu!") 
                break  
    ...
    def view_archive(self):
        """Menampilkan arsip tugas yang selesai."""
